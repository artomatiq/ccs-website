                ...
                <form className="quote__form">
                    <div className="origin-dest">
                        <div className="origin-container segment">
                            <div className="subtitle">Origin</div>
                                        ...
                                        <input
                                            ...
                                            onBlur={(e) => {
                                                if (
                                                    !selectedOrigin ||
                                                    e.target.value !==
                                                        selectedOrigin.formatted_address
                                                ) {
                                                    setSelectedOrigin("")
                                                    setFormData((prevData) => ({
                                                        ...prevData,
                                            ...
                                            style={{
                                                pointerEvents:
                                                    formData.pickupDate
                                                        ? "auto"
                                                        : "none",
                                            }} //let event propagate on disbaled input
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="dest-container segment">
                            <div className="subtitle">Destination</div>
                            <div className="dest-content">
                                <div className="form-div location">
                                    ...
                                    <Autocomplete
                                        onLoad={(autocompleteInstance) =>
                                            (autocompleteDestination.current =
                                                autocompleteInstance)
                                        }
                                        onPlaceChanged={() =>
                                            handlePlaceChanged(
                                        ...
                                        <input
                                            ...
                                            onBlur={(e) => {
                                                if (
                                                    !selectedDest ||
                                                    e.target.value !==
                                                        selectedDest.formatted_address
                                                ) {
                                                    setSelectedDest("")
                                                    setFormData((prevData) => ({
                                                        ...prevData,
                    ...
                    <div className="personal segment">
                        ...
                        <div className="form-div name">
                            <label htmlFor="dest-name" className="name-label">
                                Name
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="form-div email">
                            <label htmlFor="dest-email" className="email-label">
                                Email
                            </label>
                            <input
                                type="email"
